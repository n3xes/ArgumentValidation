...
namespace N3XeS.CSharp.ArgumentValidation.Utilities
{
	...
	public static class TypeTestingUtility
	{
		...
		public static Boolean IsBoxedTypeOf<T>([NotNull] Object valueBoxed)
		{
			valueBoxed.RequireArgumentNotNull("valueBoxed");

			return valueBoxed.GetActualType() == typeof(T);
		}
		...
		[SuppressMessage("Microsoft.Design", "CA1004:GenericMethodsShouldProvideTypeParameter",
						 Justification = "Reviewed.  Suppression is OK here.  This is required.")]
		public static Boolean IsNotBoxedTypeOf<T>([NotNull] Object valueBoxed)
		{
			valueBoxed.RequireArgumentNotNull("valueBoxed");
